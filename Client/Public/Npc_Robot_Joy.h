...
class CNpc_Robot_Joy final : public CNpc
{
private:
	CNpc_Robot_Joy(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CNpc_Robot_Joy(const CNpc_Robot_Joy& rhs);
	virtual ~CNpc_Robot_Joy() = default;
...
public:
	static CNpc_Robot_Joy* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual CNpc_Robot_Joy* Clone(void* pArg) override;
