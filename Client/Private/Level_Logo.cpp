...
HRESULT CLevel_Logo::Initialize()
{
	...
	//{
	//	//NULL_CHECK_RETURN(pGameInstance->Add_GameObject(LV_LOGO, gStrLayerID[LAYER_BACKGROUND], TEXT("Ui_BackGround")), E_FAIL);

	//	NULL_CHECK_RETURN(pGameInstance->Add_GameObject(LV_LOGO, gStrLayerID[LAYER_PLAYER], TEXT("Player_Chai")), E_FAIL);


	//	NULL_CHECK_RETURN(pGameInstance->Add_GameObject(LV_LOGO, gStrLayerID[LAYER_ENV_STATIC], TEXT("Env_Terrain")), E_FAIL);

	//	NULL_CHECK_RETURN(pGameInstance->Add_GameObject(LV_LOGO, gStrLayerID[LAYER_ENV_STATIC], TEXT("Env_Architecture")), E_FAIL);

	//	NULL_CHECK_RETURN(pGameInstance->Add_GameObject(LV_LOGO, gStrLayerID[LAYER_CAMERA], TEXT("Camera_Debug")), E_FAIL);

	//	//NULL_CHECK_RETURN(pGameInstance->Add_GameObject(LV_LOGO, gStrLayerID[LAYER_NPC], TEXT("Fiona")), E_FAIL);
